        ...
        <React.Fragment>
            <Formik
                ...
                validationSchema={Yup.object().shape({
                    email: Yup.string().email('Yêu cầu định dạng thuộc kiểu Email').max(255).required('Yêu cầu nhập Email...'),
                    username: Yup.string().required('Yêu cầu nhập Tên người dùng...'),
                    password: Yup.string().max(255).required('Yêu cầu nhập Mật khẩu...')
                })}
